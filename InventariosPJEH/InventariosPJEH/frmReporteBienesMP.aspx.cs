...
{
    public partial class frmReporteBienesMP : System.Web.UI.Page
    {
        ...
        public void MostrarDepreciacion()
        {
            ...
            switch (Trimestre)
            {
                ...
                case 1:
                    ...
                    HFNameFile.Value = "Reporte_1erTrimestre_" + Convert.ToString(TxtAnio.Text) + ".xls";
                    break;
                ...
                case 2:
                    ...
                    HFNameFile.Value = "Reporte_2doTrimestre_" + Convert.ToString(TxtAnio.Text) + ".xls";
                    break;
                ...
                case 3:
                    ...
                    FechaFinal = Convert.ToDateTime(FechaFT);
                    HFNameFile.Value = "Reporte_3erTrimestre_" + Convert.ToString(TxtAnio.Text) + ".xls";
                    break;
                ...
                case 4:
                    ...
                    FechaFinal = Convert.ToDateTime(FechaFT);
                    HFNameFile.Value = "Reporte_4toTrimestre_" + Convert.ToString(TxtAnio.Text) + ".xls";
                    break;

            }

            List<CCalculoDepreciacion> listaDepreciacion = MostrarBienesMuebles.MostrarBienesMueblesLibro(FechaInicial, FechaFinal, Convert.ToInt32(HFStatus.Value), HFTipoPartida.Value);

            if (listaDepreciacion.Count != 0 || listaDepreciacion != null)
            {
                Decimal CostoTotal = listaDepreciacion.Sum(item => item.MontoDepreciar);
